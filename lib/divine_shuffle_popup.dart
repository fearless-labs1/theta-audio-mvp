...
class DivineShufflePopupState extends State<DivineShufflePopup>
  ...
  static const Color _goliathBlue =
      Color(0xFF87CEEB); // Electric blue for Goliath
  ...
  void didUpdateWidget(DivineShufflePopup oldWidget) {
    ...
    if (widget.isGoliathMode != oldWidget.isGoliathMode &&
        _currentIntroPart == 0) {
  ...
  Color get _highlightColor =>
      widget.isGoliathMode ? _goliathBlue : _greenHighlight;
      ...
      await _ttsPlayer!.setAudioContext(AudioContext(
        ...
        android: AudioContextAndroid(
          ...
          audioFocus: AndroidAudioFocus
              .gainTransientMayDuck, // DUCK music, don't pause it
        ),
      ));
  ...
  void _checkSessionChange() {
    ...
    if (newSessionType != _currentSessionType) {
      debugPrint(
          '🔀 Session changed from $_currentSessionType to $newSessionType');
  ...
  void _onNewPrayerPlaying(String newPrayerPath) {
    ...
    final isGoliathPrayer =
        newPrayerPath.contains('/goliath/') || newPrayerPath.contains('G0');
    ...
    if (newPrayerPath == _lastPlayedPrayer) {
      debugPrint(
          '⚠️ DIVINE SHUFFLE: Same prayer detected! This should not happen.');
    }

    _lastPlayedPrayer = newPrayerPath;

    debugPrint(
        '🔀 New prayer playing: index $newIndex - ${PrayerTexts.getPrayerName(newPrayerPath)}');
  ...
  void _startPrayerCardAutoScroll() {
    ...
    _prayerCardAutoScrollTimer = Timer(const Duration(seconds: 12), () {
      ...
      final scrollDuration =
          Duration(milliseconds: (maxScroll * 50).toInt().clamp(3000, 15000));
    ...
    return AnimatedOpacity(
      ...
      child: Column(
        children: [
          ...
          // Gold divider line
          Container(height: 2, color: _goldAccent.withValues(alpha: 0.5)),
  ...
  Widget _buildSessionHeader() {
    ...
    if (widget.isGoliathMode) {
      ...
      sessionDescription =
          '50 powerful declarations against spiritual opposition';
        ...
        children: [
            ...
            children: [
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  gradient: RadialGradient(
                    colors: [
                      (widget.isGoliathMode ? _goliathBlue : _goldAccent)
                  ...
                  children: [
                    ...
                    Text(
                      ...
                      style: GoogleFonts.montserrat(
                        fontSize: 10,
                        color:
                            widget.isGoliathMode ? _goliathBlue : _subtitleText,
                        letterSpacing: 0.5,
                      ),
                    ),
                  ],
              ...
              Container(
                ...
                decoration: BoxDecoration(
                  color: widget.isGoliathMode
                      ? _goliathBlue.withValues(alpha: 0.15)
                      : _goldAccent.withValues(alpha: 0.15),
                  borderRadius: BorderRadius.circular(12),
                  border: Border.all(
                    color: widget.isGoliathMode
                        ? _goliathBlue.withValues(alpha: 0.3)
                        : _goldAccent.withValues(alpha: 0.3),
                  ),
                ),
                child: Text(
          ...
          Text(
            ...
            style: GoogleFonts.lora(
              fontSize: 11,
              fontStyle: FontStyle.italic,
              color: _bodyText.withValues(alpha: 0.8),
            ),
          ),
      ...
      child: Column(
        children: [
          ...
          Container(
            ...
            decoration: BoxDecoration(
              color: widget.isGoliathMode
                  ? _goliathBlue.withValues(alpha: 0.08)
                  : _goldAccent.withValues(alpha: 0.08),
              border: Border(
                  bottom: BorderSide(
                      color: widget.isGoliathMode
                          ? _goliathBlue.withValues(alpha: 0.2)
        ...
        return Stack(
          children: [
            ...
            Positioned(
              ...
              child: Opacity(
                opacity: 0.7,
                child: _buildPrayerCard(_getRelativePrayerIndex(-1),
                    isHighlighted: false),
              ),
            ),
            ...
            Positioned(
              ...
              right: 0,
              child:
                  _buildPrayerCard(_displayedPrayerIndex, isHighlighted: true),
            ),
  ...
  int _getRelativePrayerIndex(int offset) {
    ...
    // Wrap around
    while (index < 0) {
      index += _currentPrayerList.length;
    }
  ...
  Widget _buildPrayerCard(int index, {required bool isHighlighted}) {
    ...
    final prayerText =
        PrayerTexts.getTextByPath(prayerPath) ?? 'Prayer text not available';
            ...
            child: SingleChildScrollView(
              ...
              child: Text(
                ...
                style: GoogleFonts.lora(
                  ...
                  height: 1.5,
                  color:
                      _darkText, // FIX: Full opacity (was _bodyText.withValues(alpha: 0.8))
                ),
              ),
            ),
          ),
